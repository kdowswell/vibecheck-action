...
export function buildReviewPrompt(context: PRContext, config: Config): string {
...
export function buildInteractivePrompt(context: PRContext, command: string): string {
  return `
